...
| H001 | in_progress | 1 | 5 | 3 | +80 | territory control map を eval に加算 (係数 0.3) | (再評価は H002+H003 land 後の combined base 上で mix-eval winrate_min≥0.50 必須、単体 sweep 禁止) | exp/001 + exp 002 で discard も、**【2026-05-28 resurrect】** exp 002 submission 52716957 が成熟 LB **423.2 (+9 vs baseline 414.2)** に climb し discard 判定逆転。exp 027 で TERRITORY_WEIGHT=0.3 を現行 main (#57 frozen baseline) に再適用、gate PASS で submission **53123447** に再提出 (awaiting_lb)。learned_rules.md INFO single_opponent_winrate_not_lb_predictive |
